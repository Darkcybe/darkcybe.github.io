...
HashCat is a password cracking utility that allows various offline password attacks in order to reveal plaintext passwords from collection password hashes.

| Tool Name | Version | MITRE ATT&CK Tactic | MITRE ATT&CK Technique |
| --------- | ------- | ------------------- | ---------------------- |
| [HashCat](https://hashcat.net/hashcat/) | v6.2.6 | [Credential Access](https://attack.mitre.org/tactics/TA0006/) |
...
```bash
hashcat -m 5600 -a 0 %CREDS.TXT% /usr/share/wordlists/rockyou.txt
```
